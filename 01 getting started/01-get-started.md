...
* Provision an AI Services resource
* use the C# sdks on some examples
* use the rest api on some examples
* authenticate using key vault
* the questions at https://github.com/dgusoff/AI-102-resources/blob/main/01%20getting%20started/questions.md
* create a content moderation solution
